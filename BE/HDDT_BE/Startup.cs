...
namespace HDDT_BE
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HDDT.WebAPI", Version = "v1" });
            });
                ...
                options.AddPolicy("CorsPolicy",
                    builder => builder
                        ...
                        .WithOrigins(
                            ...
                            "http://localhost:8014",
                            "http://127.0.0.1:5500",
                            "http://cdc.vietteldongthap.vn",
                            "http://hoadoncdc.goldenkeysoft.com"
                        )
                        .AllowCredentials()
                );
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HoaDonDienTu.WebAPI v1"));
            }
