...
export default {
  ...
  methods: {
    ...
    async handleDelete() {
      if (this.model.id != 0 && this.model.id != null && this.model.id) {
        await this.$store.dispatch("khachHangStore/delete", khachHangModel.convertJson(this.model,"DM_KHACHHANG")).then((res) => {
          if (res.code===0) {
            this.fnGetList();
    ...
    async handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        if (
          ...
          console.log("LOG HANDLER UPDATE ")
          await this.$store.dispatch("khachHangStore/update", khachHangModel.toJson(this.model)).then((res) => {
            if (res.code === 0) {
          ...
          console.log("LOG HANDLER CREATE  ")
          // Create model
          await this.$store.dispatch("khachHangStore/create", khachHangModel.toJson(this.model)).then((res) => {
            if (res.code === 0) {
              this.fnGetList();
              this.showModal = false;
              this.model={}
      ...
      this.model = khachHangModel.baseJson();
      this.submitted = false;
    },
    async handleGetValue(values) {
      await this.$store.dispatch("khachHangStore/getById", values.id).then((res) => {
        if (res.code===0) {
          console.log(res)
          this.model = khachHangModel.toJson(res.data);
          this.showModal = true;
        } else {
          this.$store.dispatch("snackBarStore/addNotify", {
            message: res.message,
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("khachHangStore/getPagingParams", params)
  ...
  watch: {
    ...
    showModal(status) {
      if (status == false) this.model = khachHangModel.baseJson();
    },
    // model() {
    //   return this.model;
    // },
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input type="hidden" v-model="model.tenKhachHang"/>
                            <input
                                id="userName"
                                v-model.trim="model.tenKhachHang"
                                type="text"
                                class="form-control"
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <span style="color: red">&nbsp;*</span>
                            <input type="hidden" v-model="model.tenDonVi"/>
                            <input
                                id="lastName"
                                ...
                                :class="{
                                'is-invalid':
                                  submitted && $v.model.tenDonVi.$error,
                              }"
                            />
                            <div
                                v-if="submitted && !$v.model.tenDonVi.required"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="text-left">Mã số thuế</label>
                            <span style="color: red">&nbsp;*</span>
                            <input type="hidden" v-model="model.maSoThue"/>
                            <input
                                id="lastName"
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="text-left">Tài khoản ngân hàng</label>
                            <input type="hidden" v-model="model.taiKhoanNganHang"/>
                            <input
                                id="lastName"
                        ...
                        <div class="col-12">
                          <div class="mb-3">
                            ...
                            <span style="color: red">&nbsp;*</span>
                            <input type="hidden" v-model="model.diaChi"/>
                            <input
                                id="lastName"
                  ...
                  >
                    ...
                    <template v-slot:cell(process)="data">
                      <button
                          ...
                          v-on:click="handleGetValue(data.item)">
