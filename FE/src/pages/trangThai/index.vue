  ...
  methods: {
    ...
    async handleDelete() {
      if (this.model.id != 0 && this.model.id != null && this.model.id) {
        await this.$store.dispatch("commonStore/delete", commonModel.convertJson(this.model,"DM_TRANGTHAI")).then((res) => {
          if (res.code===0) {
            this.fnGetList();
    ...
    async handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        if (
          ...
          await this.$store.dispatch("commonStore/update", commonModel.convertJson(this.model,"DM_TRANGTHAI")).then((res) => {
            if (res.code === 0) {
          ...
          // Create model
          await this.$store.dispatch("commonStore/create", commonModel.convertJson(this.model,"DM_TRANGTHAI")).then((res) => {
            if (res.code === 0) {
              this.fnGetList();
              this.showModal = false;
              this.model = commonModel.baseJson();
    ...
    async handleGetValue(values) {
      await this.$store.dispatch("commonStore/getById", commonModel.convertJson(values,"DM_TRANGTHAI")).then((res) => {
        if (res.code===0) {
          console.log(res)
